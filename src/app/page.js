    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 selection:bg-blue-100">
      ...
      <main className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <header className="mb-16 text-center space-y-6 animate-in fade-in slide-in-from-top-4 duration-1000">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-sm font-semibold tracking-wide uppercase">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-4 max-w-4xl mx-auto">
            <div className="flex flex-col gap-2 w-full md:w-auto md:flex-1">
              <label className="text-sm font-medium text-slate-500 uppercase tracking-wider text-left sm:text-center md:text-left">
                Search Topics
              </label>
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-11 h-12 bg-white/50 backdrop-blur-sm border-white/20 shadow-sm focus:ring-2 focus:ring-blue-500 transition-all rounded-xl w-full"
                  value={searchQuery}
          ...
          <div className="flex justify-center pt-8">
            <div className="bg-white/50 backdrop-blur-sm p-1.5 rounded-2xl border border-white/20 inline-flex shadow-sm">
              <button
